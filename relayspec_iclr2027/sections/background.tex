...
DFlash supplies the fused context as key and value entries to every transformer layer of the drafter model~\citep{chen2026dflash,vaswani2017attention}. The anchor and masked positions provide the queries. Only target representations before the anchor are visible, so the drafter cannot access the tokens it is predicting.
